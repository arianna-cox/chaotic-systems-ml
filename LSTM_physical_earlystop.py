...
for c in c_array:
    ...
    train_X, test_X, train_answer, test_answer = split_training_data(observations, number_timesteps_predict, predictions = predictions)
    ...
    epoch_dictionary['physical'][c] = num_epochs
